        ...
        <div class="container">
            <div class="footer-top__header">
                ...
                <ul class="footer-top__social">
                    <li><a href="https://www.facebook.com/profile.php?id=100029087696572" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                    <li><a href="https://youtu.be/hGcAKZ1SyQ8?feature=shared" target="_blank"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
            ...
            <div class="footer-top__content">
                <div class="footer-item">
                    ...
                    <ul class="footer-item__list">
                        ...
                        <li><a href="tel:0931801102"><i class="fa fa-phone"></i>093 180 1102</a></li>
                    </ul>
                </div>
                <div class="footer-item">
