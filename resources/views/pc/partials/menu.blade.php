        ...
        <div class="menu-fix__content">
            <ul class="menu-fix__container">
                ...
                <li class="menu-fix__item">
                    ...
                    >Sản phẩm</a>
                    <ul class="menu-fix__child">
                        <li class="menu-fix__child-item"><a href="/san-pham#xop-eps">Xốp EPS</a></li>
                        <li class="menu-fix__child-item"><a href="/san-pham#xop-dinh-hinh">Xốp định hình</a></li>
                        <li class="menu-fix__child-item"><a href="/san-pham#xop-xps">Xốp XPS</a></li>
                    </ul>
                </li>
                <li class="menu-fix__item">
                ...
                <li class="menu-fix__item">
                    ...
                    <ul class="menu-fix__child">
                        ...
                        <li class="menu-fix__child-item"><a href="/tin-tuc">Tin Tập đoàn</a></li>
