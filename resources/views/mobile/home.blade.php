...
<main class="main">
    ...
    <div style="width: 100%;float: left;">
        <div class="container" style="position: relative;">
            <img style="width: 130px;position: absolute;z-index: 1;bottom: 10px;" src="/assets/img/tu-hao-thuong-hieu-quoc-gia.png" alt="">
        </div>
    </div>
                ...
                <div class="product-widget"><a href="/san-pham#thep-thanh">
                        ...
                        <div class="product-widget__content">
                            <div class="product-widget__content-center">
                                ...
                                <div class="product-widget__content-link">Xem thêm <i class="fa fa-caret-right"></i></div>
                            </div>
                        </div>
                    </a></div>
            </div>
